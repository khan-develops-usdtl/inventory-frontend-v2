...
@Component({
  selector: 'inventory-extractions-category-renderer',
  templateUrl: './extractions-category-renderer.component.html',
  styleUrls: ['./extractions-category-renderer.component.scss']
})
export class ExtractionsCategoryRendererComponent implements  AgRendererComponent, ICellRendererAngularComp {
