...
@Component({
  selector: 'inventory-screening-expiration-renderer',
  templateUrl: './screening-expiration-renderer.component.html',
  styleUrls: ['./screening-expiration-renderer.component.scss']
})
export class ScreeningExpirationRendererComponent implements AgRendererComponent, ICellRendererAngularComp {
  rowItem: IDepartment;
  cellValue: string;
