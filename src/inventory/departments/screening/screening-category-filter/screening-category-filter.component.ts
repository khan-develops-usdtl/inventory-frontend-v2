...
@Component({
  selector: 'inventory-screening-category-filter',
  templateUrl: './screening-category-filter.component.html',
  styleUrls: ['./screening-category-filter.component.scss']
})
export class ScreeningCategoryFilterComponent implements  IFloatingFilter, AgFrameworkComponent<FloatingFilterComponentParams> {
  ...
  agInit(params: any): void {
    this._screeningService.getItems().subscribe(totalItems => {
