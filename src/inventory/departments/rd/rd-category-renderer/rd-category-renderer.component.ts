...
@Component({
  selector: 'inventory-rd-category-renderer',
  templateUrl: './rd-category-renderer.component.html',
  styleUrls: ['./rd-category-renderer.component.scss']
})
export class RdCategoryRendererComponent implements  AgRendererComponent, ICellRendererAngularComp {
