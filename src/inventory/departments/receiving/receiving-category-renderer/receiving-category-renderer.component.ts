...
@Component({
  selector: 'inventory-receiving-category-renderer',
  templateUrl: './receiving-category-renderer.component.html',
  styleUrls: ['./receiving-category-renderer.component.scss']
})
export class ReceivingCategoryRendererComponent implements  AgRendererComponent, ICellRendererAngularComp {
