...
@Component({
  selector: 'inventory-mass-spec-category-filter',
  templateUrl: './mass-spec-category-filter.component.html',
  styleUrls: ['./mass-spec-category-filter.component.scss']
})
export class MassSpecCategoryFilterComponent implements  IFloatingFilter, AgFrameworkComponent<FloatingFilterComponentParams> {
  ...
  agInit(params: any): void {
    this._massSpecService.getItems().subscribe(totalItems => {
