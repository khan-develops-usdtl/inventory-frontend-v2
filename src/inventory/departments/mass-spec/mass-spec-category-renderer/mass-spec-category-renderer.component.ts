...
@Component({
  selector: 'inventory-mass-spec-category-renderer',
  templateUrl: './mass-spec-category-renderer.component.html',
  styleUrls: ['./mass-spec-category-renderer.component.scss']
})
export class MassSpecCategoryRendererComponent implements  AgRendererComponent, ICellRendererAngularComp {
  categories: string[] = ['GC', 'LC', 'Columns', 'General', 'Gases', 'Solvents', 'LDTD', 'Sciex', 'Breakroom', 'Office Supply']
  rowItem: IMaster;
  cellValue: string;
